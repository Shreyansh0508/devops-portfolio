...
const termLines = [
  ...
  { type: 'out',  text: 'AUTOMATION  : HashiCorp Vault · Argo Workflows · MCP' },
  { type: 'out',  text: 'CI/CD       : Jenkins · GitHub Actions · Argo CD' },
  { type: 'out',  text: 'LANGUAGES   : Python · Golang · Bash · JavaScript' },
  { type: 'out',  text: '─────────────────────────────────────' },
  { type: 'out',  text: 'VAULT_PROV  : ↓40%   PIPELINE_FAIL: ↓25%' },
  { type: 'out',  text: 'MANUAL_TOIL : ↓30%   UPTIME       : 99.9%' },
  { type: 'out',  text: '─────────────────────────────────────' },
